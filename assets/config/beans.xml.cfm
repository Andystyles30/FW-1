...
<beans>
	...
	<bean id="departmentService" class="bcmv3.services.Department" singleton="true">
	</bean>

	<bean id="roleService" class="bcmv3.services.role" singleton="true">
	</bean>

	<bean id="userService" class="bcmv3.services.User" singleton="true">
